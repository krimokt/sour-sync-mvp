...
const GlassInputWrapper = ({ children }: { children: React.ReactNode }) => (
  <div className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white/50 dark:bg-white/5 backdrop-blur-sm transition-all duration-300 focus-within:border-blue-500/50 focus-within:bg-white/80 dark:focus-within:bg-white/10 focus-within:ring-2 focus-within:ring-blue-500/20 group hover:border-gray-300 dark:hover:border-white/20 shadow-sm">
    {children}
  </div>
);
...
const TestimonialCard = ({ testimonial, delay }: { testimonial: Testimonial, delay: string }) => (
  <div className={`animate-testimonial ${delay} flex items-start gap-3 rounded-3xl bg-white/70 dark:bg-zinc-900/70 backdrop-blur-xl border border-white/20 dark:border-white/10 p-5 w-72 shadow-xl dark:shadow-2xl`}>
    ...
    <div className="text-sm leading-snug">
      ...
      <p className="text-blue-500 dark:text-blue-400 font-medium text-xs">{testimonial.handle}</p>
        ...
        <div className="w-full max-w-md py-10 relative z-10">
          <div className="flex flex-col gap-8">
            ...
            <form className="space-y-6" onSubmit={onSubmit}>
              ...
              {isSignUp && (
                <>
                  <div className="animate-element animate-delay-300 group">
                    <label className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2 block group-focus-within:text-blue-600 dark:group-focus-within:text-blue-400 transition-colors">Full Name</label>
                    <GlassInputWrapper>
                      <div className="relative">
                        ...
                        <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-blue-500 transition-colors duration-300" />
                      </div>
                    </GlassInputWrapper>
                  </div>

                  <div className="animate-element animate-delay-300 group">
                    <label className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2 block group-focus-within:text-blue-600 dark:group-focus-within:text-blue-400 transition-colors">Company Name</label>
                    <GlassInputWrapper>
                      <div className="relative">
                        <input 
                          name="companyName" 
                          ...
                          required 
                        />
                        <Building2 className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-blue-500 transition-colors duration-300" />
                      </div>
                    </GlassInputWrapper>
                  </div>

                  <div className="animate-element animate-delay-300 group">
                    <label className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2 block group-focus-within:text-blue-600 dark:group-focus-within:text-blue-400 transition-colors">Store URL</label>
                    <GlassInputWrapper>
                      <div className="relative flex items-center">
                        <LinkIcon className="absolute left-4 w-5 h-5 text-gray-400 group-focus-within:text-blue-500 transition-colors duration-300 z-10" />
              ...
              <div className="animate-element animate-delay-300 group">
                <label className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2 block group-focus-within:text-blue-600 dark:group-focus-within:text-blue-400 transition-colors">Email Address</label>
                <GlassInputWrapper>
              ...
              <div className="animate-element animate-delay-400 group">
                <label className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2 block group-focus-within:text-blue-600 dark:group-focus-within:text-blue-400 transition-colors">Password</label>
                <GlassInputWrapper>
                  <div className="relative">
              ...
              {!isSignUp && (
                <div className="animate-element animate-delay-500 flex items-center justify-between text-sm font-medium">
                  ...
                  <a href="#" onClick={(e) => { e.preventDefault(); onResetPassword?.(); }} className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 hover:underline transition-colors">Reset password</a>
                </div>
              )}
              ...
              <button 
                ...
                className="animate-element animate-delay-600 w-full rounded-2xl bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 py-4 font-bold text-white text-lg shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 active:scale-[0.98] hover:scale-[1.01] transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none"
              >
                {isLoading ? (
            ...
            <p className="animate-element animate-delay-900 text-center text-base text-gray-600 dark:text-gray-400">
              ...
              <a 
                ...
                className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-bold hover:underline transition-colors ml-1"
              >
