        ...
        return (
          <span
            ...
            style={{
              ...
              borderWidth: '1px',
              borderColor: circleColor ? circleColor : `var(--foreground) dark:var(--background) / ${borderOpacity / 100})`,
              top: '50%',
              left: '50%',
  ...
  return (
    <>
      {path && (
        ...
        >
          <circle
            className={cn('stroke-black/10 stroke-1 dark:stroke-white/10', pathColor)}
            cx='50%'
            cy='50%'
            r={radius}
            fill='none'
            style={pathColor ? { stroke: pathColor, opacity: 0.3 } : undefined}
          />
        </svg>
      )}
      <section
...
const AnimatedForm = memo(function AnimatedForm({
  ...
  return (
    <section className={cn('max-md:w-full flex flex-col gap-4 w-96 mx-auto p-6 rounded-2xl backdrop-blur-md bg-white/10 border border-white/20 shadow-xl', className)}>
      ...
      {googleLogin && (
        <>
          ...
          >
            <button
              className='g-button group/btn bg-transparent w-full rounded-md border h-10 font-medium outline-hidden hover:cursor-pointer hover:bg-white/5 transition-colors'
              type='button'
              onClick={() => console.log('Google login clicked')}
            >
              <span className='flex items-center justify-center w-full h-full gap-3 text-neutral-700 dark:text-neutral-300'>
                <Image
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          <button
            className='bg-gradient-to-br relative group/btn from-blue-600 dark:from-blue-600
            dark:to-blue-800 to-blue-500 block dark:bg-zinc-800 w-full text-white
        ...
        {textVariantButton && goTo && (
          <BoxReveal boxColor='var(--skeleton)' duration={0.3}>
            <section className='mt-4 text-center hover:cursor-pointer'>
              <button
                className='text-sm text-blue-500 hover:cursor-pointer outline-hidden hover:underline'
                onClick={goTo}
              >
                {textVariantButton}
              </button>
    ...
    <div className='flex max-lg:justify-center w-full md:w-auto'>
      ...
      <div className='w-full lg:w-1/2 h-[100dvh] flex flex-col justify-center items-center max-lg:px-[10%]'>
        <AnimatedForm
          ...
          submitButton={formFields.submitButton}
          textVariantButton={formFields.textVariantButton}
