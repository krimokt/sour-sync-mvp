...
export default function UserDropdown() {
  ...
  // Extract companySlug from client route: /client/[companySlug]/...
  const clientSlugMatch = pathname?.match(/^\/client\/([^/]+)/);
  const clientSlug = clientSlugMatch ? clientSlugMatch[1] : null;

  // Extract companySlug from store route: /store/[companySlug]/...
        ...
        <ul className="flex flex-col gap-1 pt-3 pb-3 border-b border-gray-200 dark:border-gray-800">
          <li>
            <DropdownItem
              ...
              tag="a"
              href={storeSlug ? `/store/${storeSlug}/settings` : '/signin'}
            ...
            >
              <svg className="fill-gray-500 group-hover:fill-[#0f7aff] dark:fill-gray-400 dark:group-hover:fill-[#0f7aff] transition-colors" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
